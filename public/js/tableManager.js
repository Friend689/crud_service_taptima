  ...
  $.fn.tablemanager = function (options = null) {
    ...
    if (options !== null) {
      ...
      if (
        ...
        // div num rows
        var numrowsDiv =
            '<div id="for_numrows" class="for_numrows d-flex" style="display: inline;"><label for="numrows">' +
            translate(voc_show_rows) +
            ': </label><select id="numrows" class="form-control mx-2"></select></div>';
      ...
      if (
        ...
        var filterbyDiv =
            '<div id="for_filter_by" class="for_filter_by d-flex" style="display: inline;"><label for="filter_by">' +
            translate(voc_filter_by) +
            ': </label><select id="filter_by" class="form-control mx-2"></select> <input id="filter_input" type="text" class="form-control" placeholder="' +
